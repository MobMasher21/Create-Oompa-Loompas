...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.IMAGINITE_BLOCK.get())
                ...
                .pattern("SSS")
                .pattern("SSS")
                .define('S', ModItems.IMAGINITE_BAR.get())
                .unlockedBy(getHasName(ModItems.IMAGINITE_BAR.get()), has(ModItems.IMAGINITE_BAR.get()))
                .save(pWriter);

        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.IMAGINITE_BAR.get(), 9)
                .requires(ModBlocks.IMAGINITE_BLOCK.get())
                .unlockedBy(getHasName(ModBlocks.IMAGINITE_BLOCK.get()), has(ModBlocks.IMAGINITE_BLOCK.get()))
                .save(pWriter);
    }
